...
class FlatSerializer(serializers.ModelSerializer):
    class Meta:
        model = Flat
        fields = ['id', 'description', 'total_area', 'address', 'facilities', 'condition', 'renovation',
...
class GarageSerializer(serializers.ModelSerializer):
    class Meta:
        model = Garage
        fields = ['id',  'description', 'total_area', 'address', 'facilities', ' quantity_parking_spaces',
                  'heating', 'price', 'image']
...
class WarehouseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Warehouse
        fields = ['id','description', 'total_area', 'address', 'facilities',
